...
class AppDownlinkCmdTypeE(betterproto2.Enum):
    ...
    app_docking_time_cmd = 5

    app_area_clean_cmd = 6
...
class AppDownlinkCmdT(betterproto2.Message):
    ...
    docking_time: "DockingTime | None" = betterproto2.field(8, betterproto2.TYPE_MESSAGE, optional=True, group="params")

    area_clean: "AreaClean | None" = betterproto2.field(9, betterproto2.TYPE_MESSAGE, optional=True, group="params")
...
@dataclass(eq=False, repr=False)
class AreaClean(betterproto2.Message):
    type: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)

    points: "list[MapPoints]" = betterproto2.field(2, betterproto2.TYPE_MESSAGE, repeated=True)


default_message_pool.register_message("", "AreaClean", AreaClean)
...
@dataclass(eq=False, repr=False)
class DevLowPowerGet(betterproto2.Message):
    uncharging_low_power: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)

    charging_low_power: "int" = betterproto2.field(2, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "dev_low_power_get", DevLowPowerGet)


@dataclass(eq=False, repr=False)
class DevLowPowerSetInfo(betterproto2.Message):
    set_uncharging_lowpower_sta: "bool" = betterproto2.field(1, betterproto2.TYPE_BOOL)

    uncharging_low_power: "int" = betterproto2.field(2, betterproto2.TYPE_INT32)

    set_charging_lowpower_sta: "bool" = betterproto2.field(3, betterproto2.TYPE_BOOL)

    charging_low_power: "int" = betterproto2.field(4, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "dev_low_power_set_info", DevLowPowerSetInfo)
...
class DevStatueT(betterproto2.Message):
    ...
    lora_connect: "int" = betterproto2.field(13, betterproto2.TYPE_INT32)

    work_time: "int" = betterproto2.field(14, betterproto2.TYPE_INT32)

    adverse_ble_rssi: "int" = betterproto2.field(15, betterproto2.TYPE_INT32)

    adverse_wifi_rssi: "int" = betterproto2.field(16, betterproto2.TYPE_INT32)

    adverse_wifi_connect_status: "int" = betterproto2.field(17, betterproto2.TYPE_INT32)

    adverse_iot_connect_status: "int" = betterproto2.field(18, betterproto2.TYPE_INT32)

    custom_list: "list[int]" = betterproto2.field(19, betterproto2.TYPE_INT32, repeated=True)

    iot_supported: "bool" = betterproto2.field(20, betterproto2.TYPE_BOOL)

    speed: "int" = betterproto2.field(21, betterproto2.TYPE_FIXED32)

    operating_power: "int" = betterproto2.field(22, betterproto2.TYPE_FIXED32)
...
@dataclass(eq=False, repr=False)
class DockingTime(betterproto2.Message):
    type: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)

    time: "DockingTimePoint | None" = betterproto2.field(2, betterproto2.TYPE_MESSAGE, optional=True)


default_message_pool.register_message("", "DockingTime", DockingTime)


@dataclass(eq=False, repr=False)
class DockingTimePoint(betterproto2.Message):
    hours: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)

    minutes: "int" = betterproto2.field(2, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "DockingTimePoint", DockingTimePoint)
...
@dataclass(eq=False, repr=False)
class GfskCfgCmdT(betterproto2.Message):
    cmd: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)
...
default_message_pool.register_message("", "gfsk_cfg_cmd_t", GfskCfgCmdT)
...
class LubaMsg(betterproto2.Message):
    ...
    pdt: "PdtMessage | None" = betterproto2.field(19, betterproto2.TYPE_MESSAGE, optional=True, group="LubaSubMsg")

    ctrl: "SpinoCtrl | None" = betterproto2.field(20, betterproto2.TYPE_MESSAGE, optional=True, group="LubaSubMsg")
...
class MctlSys(betterproto2.Message):
    ...
    to_set_dev_low_power_cmd: "DevLowPowerSetInfo | None" = betterproto2.field(
        79, betterproto2.TYPE_MESSAGE, optional=True, group="SubSysMsg"
    )

    to_get_dev_low_power_cmd: "DevLowPowerGet | None" = betterproto2.field(
        80, betterproto2.TYPE_MESSAGE, optional=True, group="SubSysMsg"
    )

    gfsk_cfg_cmd: "GfskCfgCmdT | None" = betterproto2.field(
        81, betterproto2.TYPE_MESSAGE, optional=True, group="SubSysMsg"
    )
...
@dataclass(eq=False, repr=False)
class ModulesFwInfo(betterproto2.Message):
    type: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)

    component_id: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)

    component_version: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)


default_message_pool.register_message("", "ModulesFwInfo", ModulesFwInfo)


@dataclass(eq=False, repr=False)
class ModulesName(betterproto2.Message):
    modules_name: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)


default_message_pool.register_message("", "ModulesName", ModulesName)
...
@dataclass(eq=False, repr=False)
class PdtDeviceFwInfo(betterproto2.Message):
    device_version: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)

    modules_info: "list[ModulesFwInfo]" = betterproto2.field(2, betterproto2.TYPE_MESSAGE, repeated=True)

    result: "int" = betterproto2.field(3, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "PdtDeviceFwInfo", PdtDeviceFwInfo)


@dataclass(eq=False, repr=False)
class PdtInfoReq(betterproto2.Message):
    sesstion_id: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)

    pdt_type: "int" = betterproto2.field(2, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "PdtInfoReq", PdtInfoReq)


@dataclass(eq=False, repr=False)
class PdtInfoRsp(betterproto2.Message):
    """


    Oneofs:
        - pdt_info_rsp_details:
    """

    sesstion_id: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)

    modules: "ModulesName | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, optional=True, group="pdt_info_rsp_details"
    )

    pdt_data: "PdtItem | None" = betterproto2.field(
        3, betterproto2.TYPE_MESSAGE, optional=True, group="pdt_info_rsp_details"
    )

    fw_version: "PdtDeviceFwInfo | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, optional=True, group="pdt_info_rsp_details"
    )


default_message_pool.register_message("", "PdtInfoRsp", PdtInfoRsp)


@dataclass(eq=False, repr=False)
class PdtItem(betterproto2.Message):
    data_msg: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)

    data_state: "int" = betterproto2.field(2, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "PdtItem", PdtItem)


@dataclass(eq=False, repr=False)
class PdtMessage(betterproto2.Message):
    """
    ...
    to_dev_get_pdt_info_req: "PdtInfoReq | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, optional=True, group="sub_pdt_type"
    )

    to_app_get_pdt_info_rsp: "PdtInfoRsp | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, optional=True, group="sub_pdt_type"
    )

    to_dev_control_pdt_test_req: "PdtTestMod | None" = betterproto2.field(
        3, betterproto2.TYPE_MESSAGE, optional=True, group="sub_pdt_type"
    )

    to_app_result_pdt_test_rsp: "PdtTestReq | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, optional=True, group="sub_pdt_type"
    )


default_message_pool.register_message("", "PdtMessage", PdtMessage)


@dataclass(eq=False, repr=False)
class PdtTestMod(betterproto2.Message):
    testmod: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "PdtTestMod", PdtTestMod)


@dataclass(eq=False, repr=False)
class PdtTestReq(betterproto2.Message):
    control_result: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "PdtTestReq", PdtTestReq)
...
@dataclass(eq=False, repr=False)
class PlanJobSet(betterproto2.Message):
    cmd: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)
    ...
    deviceid: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)

    starttime: "int" = betterproto2.field(6, betterproto2.TYPE_INT32)

    totalplannum: "int" = betterproto2.field(7, betterproto2.TYPE_INT32)

    planindex: "int" = betterproto2.field(8, betterproto2.TYPE_INT32)

    result: "int" = betterproto2.field(9, betterproto2.TYPE_INT32)

    speed: "int" = betterproto2.field(10, betterproto2.TYPE_FIXED32)

    operating_power: "int" = betterproto2.field(11, betterproto2.TYPE_FIXED32)
    ...
    enddate: "str" = betterproto2.field(15, betterproto2.TYPE_STRING)

    triggertype: "int" = betterproto2.field(16, betterproto2.TYPE_INT32)

    day: "int" = betterproto2.field(17, betterproto2.TYPE_INT32)

    weeks: "list[int]" = betterproto2.field(18, betterproto2.TYPE_INT32, repeated=True)

    remained_seconds: "int" = betterproto2.field(19, betterproto2.TYPE_INT32)

    enable: "int" = betterproto2.field(20, betterproto2.TYPE_INT32)


default_message_pool.register_message("", "PlanJobSet", PlanJobSet)
...
class ResponseSetModeT(betterproto2.Message):
    ...
    custom_list: "list[int]" = betterproto2.field(8, betterproto2.TYPE_INT32, repeated=True)
...
class RptDevStatus(betterproto2.Message):
    ...
    headlamp_status: "int" = betterproto2.field(15, betterproto2.TYPE_INT32)
...
@dataclass(eq=False, repr=False)
class SpinoCtrl(betterproto2.Message):
    plan_job_set: "PlanJobSet | None" = betterproto2.field(1, betterproto2.TYPE_MESSAGE, optional=True)


default_message_pool.register_message("", "SpinoCtrl", SpinoCtrl)
...
class WorkModeT(betterproto2.Message):
    ...
    custom_list: "list[int]" = betterproto2.field(2, betterproto2.TYPE_INT32, repeated=True)
